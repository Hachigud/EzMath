...
if($_GET['aux']==''){
    header("Location: EjercicioEstadisticaNv2_3.php?aux=0&Pnivel=1");
}
if($_GET['Pnivel'] != 1 ){
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <br>
             <h2> Calcular la mediana de los siguientes datos: 3,10,4,20,7,5,8,1,6,11,14 </h2> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 3 Estadisticas Nivel 2</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/BZNSZpXuwfk" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                <p class="form-label">Seleccione la alternativa correcta: </p>
                 ...
                 <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Estadisticas Nivel 2 Ejercicio 3"> 
...
<div class="quiz-container">
    ...
    <p class="form-label">Muchas gracias por contactarnos :) </p>
     ...
     <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Estadistica Nivel 2 Ejercicio 3"> 
...
<audio id="AudioCompletado" src="../../../../Documentos/Completado.mp3" preload="auto"></audio>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/BZNSZpXuwfk';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioEstadisticaNv2_3.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioEstadisticaNv2_3.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
