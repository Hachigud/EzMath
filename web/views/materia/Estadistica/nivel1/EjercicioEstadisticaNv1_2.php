...
if($_GET['aux']==''){
    header("Location: EjercicioEstadisticaNv1_2.php?aux=0&Pnivel=1");
}
if($_GET['Pnivel'] != 1 ){
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <br>
             <h2> El color de los ojos de tus compañeros de clase es una variable: </h2> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 2 Estadisticas Nivel 1</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/CHmCNg7l2k0" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                <p class="form-label">Seleccione la alternativa correcta: </p>
                 ...
                 <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Estadisticas Nivel 1 Ejercicio 2"> 
                 <input type="hidden" name="Nombre_Nivel" id="Nombre_Nivel" value="Estadisticas_Nv1">   
                 <ul id="Respuesta" >
                 <li> 
                     <input type="radio" id="a" value="a" name="respuesta">  
                     <label for="a"> Cantitativa </label>
                </li> 
                <li> 
                ...
                <li> 
                     ...
                     <label for="c">Calculativa</label>
                </li> 
                <li> 
                     <input type="radio" id="d"  value="d" name="respuesta">  
                     <label for="d">Cualitativa</label>
                </li> 
                </ul> 
...
<div class="quiz-container">
    ...
    <p class="form-label">Muchas gracias por contactarnos :) </p>
     ...
     <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Estadistica Nivel 1 Ejercicio 2"> 
...
<div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/CHmCNg7l2k0';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioEstadisticaNv1_2.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
