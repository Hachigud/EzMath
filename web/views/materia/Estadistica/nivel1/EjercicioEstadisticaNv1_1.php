    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <div name="Pregunta" >   <p> Pregunta  N°1 Estadisticas </p>  
             <br>
             <h2> La cantidad de alumnos en un colegio es una variable: </h2> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 1 Estadisticas Nivel 1</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Z8ctH9FyWe4" id="iframeVideo"></iframe>
                    </div>
            </div>
...
<div class="quiz-container">
    ...
    <p class="form-label">Muchas gracias por contactarnos :) </p>
     ...
     <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Estadistica Nivel 1 Ejercicio 1"> 
...
<div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/Z8ctH9FyWe4';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioEstadisticaNv1_1.php?aux=0'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = './EjercicioEstadisticaNv1_2.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioEstadisticaNv1_1.php?aux=1'
                        });
                    }
                })
            return false;
        ...
        .done(function(data) {
            ...
            if (data != '') {
                Swal.fire("Muchas Gracias!", "El  Reporte fue Enviado con éxito! :)", "success").then(
                    function() {
                        window.location.href = 'EjercicioEstadisticaNv3_2.php?aux=0';
                    });
            } else {
