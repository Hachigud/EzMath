...
if($_GET['aux']==''){
    header("Location: EjercicioAlgebraNv2_2.php?aux=0&Pnivel=1");
}
if($_GET['Pnivel'] != 1 ){
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <div name="Pregunta" >   <p> Pregunta  N°2 Algebra </p>  
             <br>
             <h3> En un rectángulo la base mide 17 cm más que la altura <br> y el perímetro mide 70 cm. 
             ¿Cuáles son las dimensiones del rectángulo? </h3> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 2 Algebra Nivel 2</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/v4pUIzaaA8k" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                <p class="form-label">Seleccione la alternativa correcta: </p>
                 ...
                 <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Algebra Nivel 2 Ejercicio 2"> 
                 <input type="hidden" name="Nombre_Nivel" id="Nombre_Nivel" value="Algebra_Nv2">  
                 <ul id="Respuesta">
                 <li> 
                     <input type="radio" id="a" value="a" name="respuesta">  
                     <label for="a"> Altura = 11cm y Base = 28cm </label>
                </li> 
                <li> 
                    
                     <input type="radio" id="b" value="b" name="respuesta">  
                     <label for="b">Altura = 5cm y Base = 22cm</label>
                </li> 
                <li> 
                     <input type="radio" id="c" value="c" name="respuesta">  
                     <label for="c">Altura = 9cm y Base = 26cm</label>
                </li> 
                <li> 
                     <input type="radio" id="d"  value="d" name="respuesta">  
                     <label for="d">Altura = 15cm y Base = 22cm</label>
                </li> 
                </ul> 
...
<div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/v4pUIzaaA8k';
            ...
            $.post("../../../../app/controllers/PreguntaController.php", $("#Respuesta_ejercicio").serialize())
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            'Cuidado!',
                            'Recueda que Debes escoger una respuesta',
                            'info'
                        ).then(() => {
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioAlgebraNv2_2.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
