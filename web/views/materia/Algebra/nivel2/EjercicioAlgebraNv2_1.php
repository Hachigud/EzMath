    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <div name="Pregunta" >   <p> Pregunta  N°1 Algebra </p>  
             <br>
             <h3> Tres Amigos, Juan, Pedro y Matias se reparten $1300 dolares. <br>
              Juan recibe el doble que Pedro y Pedro el cuádruple que Matias.  <br >
             ¿Cuánto recibe cada uno? </h3> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 1 Algebra Nivel 2</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/ndulf2AkS1I" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                <p class="form-label">Seleccione la alternativa correcta: </p>
                 ...
                 <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Algebra Nivel 2 Ejercicio 1"> 
                 <input type="hidden" name="Nombre_Nivel" id="Nombre_Nivel" value="Algebra_Nv2">  
                 <ul id="Respuesta">
                 <li> 
                     <input type="radio" id="a" value="a" name="respuesta">  
                     <label for="a"> Matias recibe 400, Pedro 800 y Juan 100 </label>
                </li> 
                <li> 
                    
                     <input type="radio" id="b" value="b" name="respuesta">  
                     <label for="b">Matias recibe 300, Pedro 700 y Juan 200</label>
                </li> 
                <li> 
                     <input type="radio" id="c" value="c" name="respuesta">  
                     <label for="c">Matias recibe 100, Pedro 400 y Juan 800</label>
                </li> 
                <li> 
                     <input type="radio" id="d"  value="d" name="respuesta">  
                     <label for="d">Matias recibe 200, Pedro 500 y Juan 600</label>
                </li> 
                </ul> 
...
<div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/ndulf2AkS1I';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioAlgebraNv2_1.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = './EjercicioAlgebraNv2_2.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioAlgebraNv2_1.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
        ...
        .done(function(data) {
            ...
            if (data != '') {
                Swal.fire("Muchas Gracias!", "El  Reporte fue Enviado con éxito! :)", "success").then(
                    function() {
                        window.location.href = 'EjercicioAlgebraNv2_1.php?aux=0';
                    });
            } else {
