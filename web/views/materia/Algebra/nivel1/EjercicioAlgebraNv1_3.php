...
if($_GET['aux']==''){
    header("Location: EjercicioAlgebraNv1_3.php?aux=0&Pnivel=1");
}
if($_GET['Pnivel'] != 1 ){
    header("Location: EjercicioAlgebraNv1_1.php?aux=0");
}
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Ejercicios Nivel N°1 Algebra</strong></h3>
                        </div>
             ...
             <div name="Pregunta" >   <p> Pregunta  N°3 Algebra </p>  
             <br>
             <h2> Pedro tiene 21 años menos que su amigo Benjamin y sabemos <br>
             que la suma de sus edades es 47.  
             ¿Qué edad tiene cada uno de ellos? </h2> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 3 Algebra Nivel 1</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/DoEXYSNY2z8" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                <p class="form-label">Seleccione la alternativa correcta: </p>
                 ...
                 <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Algebra Nivel 1 Ejercicio 3"> 
                 <input type="hidden" name="Nombre_Nivel" id="Nombre_Nivel" value="Algebra_Nv1"> 
                 <input type="hidden" name="email" id="email" value="<?php  echo $email ?>">   
                 <ul id="Respuesta">
                 <li> 
                     <input type="radio" id="a" value="a" name="respuesta">  
                     <label for="a"> La edad de Pedro es 13  y la de Juan es 34 </label>
                </li> 
                <li> 
                    
                     <input type="radio" id="b" value="b" name="respuesta">  
                     <label for="b">La edad de Pedro es 17  y la de Juan es 30</label>
                </li> 
                <li> 
                     <input type="radio" id="c" value="c" name="respuesta">  
                     <label for="c">La edad de Pedro es 20  y la de Juan es 27</label>
                </li> 
                <li> 
                     <input type="radio" id="d"  value="d" name="respuesta">  
                     <label for="d">La edad de Pedro  es34  y la de Juan es 13</label>
                </li> 
                </ul> 
...
<audio id="AudioCompletado" src="../../../../Documentos/Completado.mp3" preload="auto"></audio>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/DoEXYSNY2z8';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioAlgebraNv1_3.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioAlgebraNv1_3.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
