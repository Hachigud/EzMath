...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <br>
             <h3> Juan tiene 25 años, que es la tercera parte de la edad de su madre. <br>
             ¿Qué edad tiene la madre de Juan? </h3> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 1 Algebra Nivel 1</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/ZQuI0YCrUMY" id="iframeVideo"></iframe>
                    </div>
            </div>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/ZQuI0YCrUMY';
            ...
            $.post("../../../../app/controllers/PreguntaController.php", $("#Respuesta_ejercicio").serialize())
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            'Cuidado!',
                            'Recuerda Debes escoger una respuesta :)',
                            'info'
                        ).then(() => {
                            window.location.href = 'EjercicioAlgebraNv1_1.php?aux=0'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = './EjercicioAlgebraNv1_2.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            'Ups!',
                            'La respuesta es incorrecta, Intentalo denuevo :c',
                            'error'                           
                        ).then(() => {
                            window.location.href = 'EjercicioAlgebraNv1_1.php?aux=1'
                        });
                    }
                })
            return false;
