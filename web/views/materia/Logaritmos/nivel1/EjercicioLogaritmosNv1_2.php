...
if($_GET['aux']==''){
    header("Location: EjercicioLogaritmosNv1_2.php?aux=0&Pnivel=1");
}
if($_GET['Pnivel'] != 1 ){
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <img class="img-fluid"  src=../../../../img/Problemas/Problema_Logaritmos2_N1.png> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 2 Logaritmos Nivel 1</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/sz22TXFkym4" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                <p class="form-label">Seleccione la alternativa correcta: </p>
                 ...
                 <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Logaritmos Nivel 1 Ejercicio 2"> 
...
<div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/sz22TXFkym4';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioLogaritmosNv1_2.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
