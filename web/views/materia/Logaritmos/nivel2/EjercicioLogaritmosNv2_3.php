...
if($_GET['aux']==''){
    header("Location: EjercicioLogaritmosNv2_3.php?aux=0&Pnivel=1");
}
if($_GET['Pnivel'] != 1 ){
    header("Location: EjercicioLogaritmosNv2_1.php?aux=0");
}
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Ejercicios Nivel N°2 Logaritmos</strong></h3>
                        </div>
             ...
             <br>
             <h2> Resuelva el siguiente logaritmo </h2> 
            
             <img class="img-fluid"  src=../../../../img/Problemas/Problema_Logaritmos3_N2.png> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 3 Logaritmos Nivel 2</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/MUyHIeDYbRo" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                <p class="form-label">Seleccione la alternativa correcta: </p>
                 ...
                 <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Logaritmos Nivel 2 Ejercicio 3"> 
                 <input type="hidden" name="Nombre_Nivel" id="Nombre_Nivel" value="Logaritmos_Nv2"> 
...
<audio id="AudioCompletado" src="../../../../Documentos/Completado.mp3" preload="auto"></audio>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/MUyHIeDYbRo';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioLogaritmosNv2_3.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioLogaritmosNv2_3.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
