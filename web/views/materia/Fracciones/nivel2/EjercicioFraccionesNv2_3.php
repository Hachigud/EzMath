...
if($_GET['aux']==''){
    header("Location: EjercicioFraccionesNv2_3.php?aux=0&Pnivel=1");
}
if($_GET['Pnivel'] != 1 ){
    header("Location: EjercicioFraccionesNv2_1.php?aux=0");
}
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Ejercicios Nivel N°2 Fracciones</strong></h3>
                        </div>
             ...
             <div name="Pregunta" >   <p> Pregunta  N°3 Fracciones </p>  
             <br>
             <h2> Un padre deja a sus 3 hijos una herencia de $150.000, el mayor  <br> toca 4/9 de esa cantidad, el hijo de al medio toca 1/3 y el menor el resto
             <br>¿Cuando dinero recibio cada uno?</h2> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 3 Fracciones Nivel 2</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Y7iHHI4xVM4" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                <p class="form-label">Seleccione la alternativa correcta: </p>
                 <br>
                 <input type="hidden" name="RespuestaPreguntaAcEs" value="1">
                 <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Fracciones Nivel 2 Ejercicio 3"> 
                 <input type="hidden" name="Nombre_Nivel" id="Nombre_Nivel" value="Fracciones_Nv2">
                 <input type="hidden" name="email" id="email" value="<?php  echo $email ?>">      
                 <ul id="Respuesta" >
                 <li> 
                     <input type="radio" id="a" value="a" name="respuesta">  
                     <label for="a"> Mayor:66.666, Medio: 50.000, Menor: 33.334 </label>
                </li> 
                <li> 
                    
                     <input type="radio" id="b" value="b" name="respuesta">  
                     <label for="b"> Mayor:60.000, Medio: 40.000, Menor: 50.000</label>
                </li> 
                <li> 
                     <input type="radio" id="c" value="c" name="respuesta">  
                     <label for="c"> Mayor:100.000, Medio: 30.000, Menor: 20.000</label>
                </li> 
                <li> 
                     <input type="radio" id="d"  value="d" name="respuesta">  
                     <label for="d">Mayor:80.000, Medio: 40.000, Menor: 30.000</label>
                </li> 
                </ul> 
...
<audio id="AudioCompletado" src="../../../../Documentos/Completado.mp3" preload="auto"></audio>
            </main>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/Y7iHHI4xVM4';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioFraccionesNv2_3.php?aux=0&Pnivel=1'
                        });
                        
                      
                    }
                    else if (data == 'true') { 
                        document.getElementById('AudioCompletado').play();
                        confetti({
                        particleCount: 2000,
                        startVelocity: 80,
                        spread: 360,
                        ...
                        Swal.fire(
                            'Correcto!',
                            'La respuesta es Correcta, Completaste el nivel. Felicitaciones! Sigue Asi! :)',
                            'success'
                        ).then(() => {
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioFraccionesNv2_3.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
