...
if($_GET['aux']==''){
    header("Location: EjercicioFraccionesNv1_2.php?aux=0&Pnivel=1");
}
if($_GET['Pnivel'] != 1 ){
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <br>
             <h2> Resuelva el siguiente problema </h2> 
            
             <img class="img-fluid"  src=../../../../img/Problemas/Problema_Fracciones2_N1.png> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 2 Fracciones Nivel 1</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/AKnEXsIKnzg" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                <p class="form-label">Seleccione la alternativa correcta: </p>
                 ...
                 <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Fracciones Nivel 1 Ejercicio 2"> 
                ...
                <li> 
                     ...
                     <label for="c">11/8</label>
                </li> 
                <li> 
                     <input type="radio" id="d"  value="d" name="respuesta">  
                     <label for="d">49/15</label>
                </li> 
                </ul> 
...
<div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/AKnEXsIKnzg';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioFraccionesNv1_2.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioFraccionesNv1_2.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
