    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <div name="Pregunta" >   <p> Pregunta  N°1 Fracciones </p>  
             <br>
             <h2> Juan tiene 60 manzanas, el se comio 1/5 de las manzanas y su <br>amigo 1/2,  
            que fraccion  de las manzas se comieron entre ellos y a cuantas manzanas equivale  </h2> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 1 Fracciones Nivel 3</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/5viGSSKS6PY" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                <p class="form-label">Seleccione la alternativa correcta: </p>
                 ...
                 <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Fracciones Nivel 3 Ejercicio 1"> 
                 <input type="hidden" name="Nombre_Nivel" id="Nombre_Nivel" value="Fracciones_Nv3">   
                 <ul id="Respuesta" >
                 <li> 
                     <input type="radio" id="a" value="a" name="respuesta">  
                     <label for="a"> Entre los 2 comen 2/10, lo que equivale a 12 manzanas </label>
                </li> 
                <li> 
                    
                     <input type="radio" id="b" value="b" name="respuesta">  
                     <label for="b">Entre los 2 comen 4/10, lo que equivale a 24 manzanas</label>
                </li> 
                <li> 
                     <input type="radio" id="c" value="c" name="respuesta">  
                     <label for="c">Entre los 2 comen 2/7, lo que equivale a 17 manzanas</label>
                </li> 
                <li> 
                     <input type="radio" id="d"  value="d" name="respuesta">  
                     <label for="d">Entre los 2 comen 7/10, lo que equivale a 42 manzanas</label>
                </li> 
                </ul> 
...
<div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/5viGSSKS6PY';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioFraccionesNv3_1.php?aux=0'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = './EjercicioFraccionesNv3_2.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioFraccionesNv3_1.php?aux=1'
                        });
                    }
                })
            return false;
