...
if($_GET['aux']==''){
    header("Location: EjercicioFraccionesNv3_3.php?aux=0&Pnivel=1");
}
if($_GET['Pnivel'] != 1 ){
    header("Location: EjercicioFraccionesNv3_1.php?aux=0");
}
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Ejercicios Nivel N°3 Fracciones</strong></h3>
                        </div>
             ...
             <br>
             <h2> De cierto número de problemas, Roberto resuelve el 
                 primer día<br> 3/10 del total y en el segundo día resuelve 5/7 de lo que faltaba resolver, <br> lo que es igual a 50 problemas ¿Cuántos problemas le falta resolver?
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 3 Fracciones Nivel 3</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/c4FdVFc1pqE" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                <p class="form-label">Seleccione la alternativa correcta: </p>
                 ...
                 <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Fracciones Nivel 3 Ejercicio 3"> 
                 <input type="hidden" name="Nombre_Nivel" id="Nombre_Nivel" value="Fracciones_Nv3">
...
<audio id="AudioCompletado" src="../../../../Documentos/Completado.mp3" preload="auto"></audio>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/c4FdVFc1pqE';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioFraccionesNv3_3.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioFraccionesNv3_3.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
