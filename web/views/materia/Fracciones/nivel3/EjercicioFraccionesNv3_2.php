...
if($_GET['aux']==''){
    header("Location: EjercicioFraccionesNv3_2.php?aux=0&Pnivel=1");
}
if($_GET['Pnivel'] != 1 ){
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <div name="Pregunta" >   <p> Pregunta  N°2 Fracciones </p>  
             <br>
             <h2> Miguel tiene un terreno de 1000Km, de los cuales vende a un comprador <br>2/5, de lo que queda vende 1/4 a otro y el resto se lo queda 
                 ¿Con cuantos KM se quedo? </h2> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 2 Fracciones Nivel 3</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/uz6kbzE7rhQ" id="iframeVideo"></iframe>
                    </div>
            </div>
...
<div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/uz6kbzE7rhQ';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioFraccionesNv3_2.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
