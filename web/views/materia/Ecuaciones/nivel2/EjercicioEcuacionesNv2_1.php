    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <div name="Pregunta" >   <p> Pregunta  N°1 Ecuaciones </p>  
             <br>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/5cqEbd8o3n8" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                ...
                <li> 
                     ...
                     <label for="c">2 y -2</label>
                </li> 
                <li> 
                     <input type="radio" id="d"  value="d" name="respuesta">  
                     <label for="d">Solo 2</label>
                </li> 
                </ul> 
...
<div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/5cqEbd8o3n8';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioEcuacionesNv2_1.php?aux=0'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioEcuacionesNv2_1.php?aux=1'
                        });
                    }
                })
            return false;
