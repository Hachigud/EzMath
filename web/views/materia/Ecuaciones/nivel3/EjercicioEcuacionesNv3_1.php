    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <br>
             <h2> Resuelva la siguiente ecuacion de grado 3 </h2> 
            
             <img class="img-fluid"  src=../../../../img/Problemas/Problema_Ecuaciones3_N1.png> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 1 Ecuaciones Nivel 3</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/0djw_NnnzFA" id="iframeVideo"></iframe>
                    </div>
            </div>
...
<div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/0djw_NnnzFA';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioEcuacionesNv3_1.php?aux=0'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioEcuacionesNv3_1.php?aux=1'
                        });
                    }
                })
            return false;
