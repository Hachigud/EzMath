...
if($_GET['aux']==''){
    header("Location: EjercicioPorcentajesNv3_2.php?aux=0&Pnivel=1");
}
if($_GET['Pnivel'] != 1 ){
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
             ...
             <div name="Pregunta" >   <p> Pregunta  N°2 Porcentajes </p>  
             <br>
             <h2> El 25% de los juegos que tiene Elias son de accion, 40% de rol y el resto son <br>de deportes.
             si Elias tiene 70 juegos de deportes, ¿cuántos tiene de rol?
             </h2> 
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 2 Porcentajes Nivel 3</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/I0hD1d3BulM" id="iframeVideo"></iframe>
                    </div>
            </div>
...
<div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/I0hD1d3BulM';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioPorcentajesNv3_2.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioPorcentajesNv3_2.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
