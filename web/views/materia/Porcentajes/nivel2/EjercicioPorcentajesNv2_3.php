...
if($_GET['aux']==''){
    header("Location: EjercicioPorcentajesNv2_3.php?aux=0&Pnivel=1");
}
if($_GET['Pnivel'] != 1 ){
    header("Location: EjercicioPorcentajesNv2_1.php?aux=0");
}
                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Ejercicios Nivel N°2 Porcentajes</strong></h3>
                        </div>
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 3 Porcentajes Nivel 2</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/7RCHHyNn4IQ" id="iframeVideo"></iframe>
                    </div>
            </div>
            ...
            <div class="quiz-container">
                <p class="form-label">Seleccione la alternativa correcta: </p>
                 ...
                 <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Porcentajes Nivel 2 Ejercicio 3"> 
                 <input type="hidden" name="Nombre_Nivel" id="Nombre_Nivel" value="Porcentajes_Nv2">
                 <input type="hidden" name="email" id="email" value="<?php  echo $email ?>">      
                 <ul id="Respuesta" >
                 <li> 
                     <input type="radio" id="a" value="a" name="respuesta">  
                     <label for="a"> 1.2345 </label>
                </li> 
                <li> 
                    
                     <input type="radio" id="b" value="b" name="respuesta">  
                     <label for="b">12.345</label>
                </li> 
                <li> 
                     <input type="radio" id="c" value="c" name="respuesta">  
                     <label for="c">123.45</label>
                </li> 
                <li> 
                     <input type="radio" id="d"  value="d" name="respuesta">  
                     <label for="d">1234.5</label>
                </li> 
                </ul> 
...
<audio id="AudioCompletado" src="../../../../Documentos/Completado.mp3" preload="auto"></audio>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/7RCHHyNn4IQ';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioPorcentajesNv2_3.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioPorcentajesNv2_3.php?aux=1&Pnivel=1'
                        });
                    }
                })
            return false;
