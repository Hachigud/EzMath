        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Solucion Ejercicio 1 Porcentajes Nivel 2</h5>
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Xxt1tOBdTi0" id="iframeVideo"></iframe>
                    </div>
            </div>
...
<div class="quiz-container">
    ...
    <p class="form-label">Muchas gracias por contactarnos :) </p>
     ...
     <input type="hidden" name="Pregunta" id="Pregunta" value="Pregunta Porcentajes Nivel 3 Ejercicio 1"> 
...
<div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script type="text/javascript">
      ...
      var videoSrc='https://www.youtube.com/embed/Xxt1tOBdTi0';
                ...
                .done(function(data) {
                    ...
                    if (data == 'Nres') { 
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioPorcentajesNv2_1.php?aux=0'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = './EjercicioPorcentajesNv2_2.php?aux=0&Pnivel=1'
                        });
                        ...
                        Swal.fire(
                            ...
                            window.location.href = 'EjercicioPorcentajesNv2_1.php?aux=1'
                        });
                    }
                })
            return false;
