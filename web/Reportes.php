...
<body>
                        ...
                        <div class="col-12 col-lg-12 col-xxl-12 d-flex">
                            <div class="card flex-fill p-4 table-responsive">
                                ...
                                <table id="table_id"  data-page-length='10' class="display">
                                    <thead>
                                        <tr>
                                        <th style="width:13%"><p align="center">Correo Usuario </p></th>
                                            <th> <p align="center">Ejercicio </p></th>
                                            <th><p align="center">Descripcion Reporte </p></th>
                                            <th><p align="center">Eliminar Reporte </p></th>                            
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php foreach ($Reportes as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= $row->nombre_ejercicio ?></td>
                                                    <td><?= $row->descripcion_reporte ?></td>       
                                                    <td><button class="btn btn-danger"
                                                        onclick="borrarReporte(<?= $row->id_reporte ?>)">Borrar Reporte</button>
                                                </td>
                                            </tr>                                               
                                                </tr>
                                            <?php } ?>
    ...
    <script src="./app/script/gestionar-Reportes.js"></script>
